...
const featuresData = [
  {
    ...
    features: [
      {
        icon: (
          <MapPin className="h-12 w-12 text-gray-500 mr-2 transition-colors duration-200 hover:text-gray-500" />
        ),
        title: "Trip Planner",
      ...
      {
        icon: (
          <Users className="h-12 w-12 text-gray-500 mr-2 transition-colors duration-200 hover:text-gray-500" />
        ),
        title: "Guide",
      ...
      {
        icon: (
          <Info className="h-12 w-12 text-gray-500 mr-2 transition-colors duration-200 hover:text-gray-500" />
        ),
        title: "Info",
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex flex-col items-center">
            <div className="flex flex-row">
              <img
                src={featuresData[currentIndex].image}
                alt="Feature Image"
                className="w-120 h-60 object-cover rounded-lg mr-4"
              />
              <div className="flex flex-col justify-center">
                {featuresData[currentIndex].features.map((feature, index) => (
                  <div
                    key={index}
                    className="flex items-center mb-4 text-center hover:text-gray-500 transition-colors duration-200"
                  >
                    {feature.icon}
                    <div>
      ...
      <main>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
              {[
                ...
                {
                  name: "Stella",
                  country: "Zurich, Swiss",
                  image: "/images/stella.png",
                },
                {
                  name: "Januar",
                  country: "Munich, Jerman",
                  image: "/images/januar.png",
                },
                {
                  name: "Gio",
                  country: "Amsterdam, Belanda",
                  image: "/images/gio.png",
                },
              ].map((city, index) => (
                <Popular key={index} city={city} />
              ))}
            </div>
          </div>
        </section>
        ...
        <section className="py-16 text-center">
          <h2 className="text-3xl md:text-4xl font-bold max-w-4xl mx-auto px-4">
            "Better to <span className="text-red-600">SEE</span> something once
            than hear about it{" "}
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="text-white">
                ...
                <h2 className="text-4xl font-bold mb-8">
                  Berangkat <span className="text-red-600">Kapan Saja</span>{" "}
                  Semaumu
                </h2>
                <PrivateTripFeatures />
              </div>
              <div className="grid grid-cols-2 gap-4">
                <TripInfoCard
                  ...
                  description="Curhat aja semuanya!"
                />
                <TripInfoCard
                  title="Local Guide"
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            ...
            <p className="text-gray-600 mb-8">
              Pengalaman seru dari para Traveler
            </p>
