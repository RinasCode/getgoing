  ...
  return (
    ...
    >
      <div className="w-full max-w-md bg-white rounded-lg shadow-md p-8">
        <h2 className="text-2xl font-bold mb-1 text-left">Register</h2>
        <p className="text-sm font-bold text-gray-600 mb-6 text-left">
          Buat akun & masukkan data diri Anda
        </p>
        ...
        <div className="mt-6 text-center text-sm">
          <span className="text-gray-600">Sudah punya akun? Silahkan </span>
          <Link
            to="/login"
